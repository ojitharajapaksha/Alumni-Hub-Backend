...
export interface ApiBatchmateBatchmate extends Struct.CollectionTypeSchema {
  collectionName: 'batchmates';
  info: {
    description: 'Alumni batchmate records';
    displayName: 'Batchmate';
    pluralName: 'batchmates';
    singularName: 'batchmate';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiNotificationNotification
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['new_user', 'new_batchmate', 'update', 'system']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
